...
describe('GET /api/v1/cars', () => {
    ...
    test('GET /api/v1/cars with admin user should respond with an array of users', async () => {
        return request(app)
            .get('/api/v1/cars')
    ...
    test('GET /api/v1/cars/:id with admin user should respond with a car', async () => {
        return request(app)
            .get('/api/v1/cars/' + carId)
            .set('x-access-token', adminToken)
            .expect('Content-Type', /json/)
            .expect(200, {
                self: '/api/v1/car/' + carId,
                brand: 'testbrand',
                model: 'testmodel',
                plate: 'AA000AA',
                description: 'testdescription',
    ...
    test('GET /api/v1/cars with normal user should respond with status code 401', async () => {
        return request(app)
            .get('/api/v1/cars')
...
describe('POST /api/v1/cars', () => {
    ...
    test('POST /api/v1/cars with brand not specified', async () => {
        return request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
    ...
    test('POST /api/v1/cars with model not specified', () => {
        return request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
            .set('Accept', 'application/json')
    ...
    test('POST /api/v1/cars with plate not specified', () => {
        return request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
            .set('Accept', 'application/json')
    ...
    test('POST /api/v1/cars with plate duplicate', async () => {
        await request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
    ...
    test('POST /api/v1/cars with owner not specified', () => {
        return request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
            .set('Accept', 'application/json')
    ...
    test('POST /api/v1/cars with valid data', () => {
        return request(app)
            .post('/api/v1/cars')
            .set('x-access-token', adminToken)
            .set('Accept', 'application/json')
